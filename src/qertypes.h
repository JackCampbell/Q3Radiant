...
enum {
	...
	ECLASS_ANGLE = BIT(1),
	ECLASS_PATH = BIT(2),
	ECLASS_MISCMODEL = BIT(3),
	ECLASS_SOUND = BIT(4),
	// HL
	ECLASS_DECAL = BIT(5),
	ECLASS_SPRITE = BIT(6),
	ECLASS_BEAM = BIT(7),
	ECLASS_MULTI_MANAGER = BIT(8),
	ECLASS_MULTISOURCE = BIT(9),
	// Q1/HX2
	ECLASS_INTERMISSION = BIT(10),
	// Q2
	ECLASS_TARGET_SPAWNER = BIT(11),
	// RTCW/ET
	ECLASS_AI_CHAR = BIT(12),
	ECLASS_TEAM_CHAR = BIT(13),
	// -- end
...
enum terrainnoise_t {
	NOISE_NONE, NOISE_PLUS, NOISE_PLUSMINUS
};
enum terrainbrush_t {
	TERRAIN_BRUSH_CIRCLE, TERRAIN_BRUSH_SQUARE
};
enum terrainfalloff_t {
	TERRAIN_FALLOFF_LINEAR, TERRAIN_FALLOFF_CURVED
};
